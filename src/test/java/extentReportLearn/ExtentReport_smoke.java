...
public class ExtentReport_smoke {
    ...
    public void createSetup(){
        ...
        spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/ExtentReport/reqresTestExecutionReport_smoke.html"); //current path of the project using System.getProperty
//System.getProperty("user.dir") == C:\Users\sunilk\IdeaProjects\TestNG_RestAssurd\ExtentReport
    ...
    public void validateSoapIdAndEmail() {
        logger.info("This is for smoke test information about email validation");
